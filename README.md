...
## Hi! My name is Bianca,  <img align="center" width="100" height="80" src="https://c.tenor.com/TdXGUNE47FgAAAAj/mandalorian-baby-yoda.gif">
  I'm a **Front-end developer from Florianópolis, Brazil**. I'm currently working on @JungleDevs team as a Software Engineer Intern, working mostly on challenges using, **JavaScript, CSS, HTML and React.** Also, I'm learning about User Interface and User Experience (UI/UX) and tools like **Figma and Adobe XD**. As a developer I think it is important to understand beyond the code, because we are programming from people to people.
